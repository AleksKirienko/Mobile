...
public class WaterRenderer implements GLSurfaceView.Renderer {
    ...
    final int N = 60; // длина распространения волны
    float K = 0.06f; // коэф. деформации поверхности при попадании капли о поверхность
    float DT = 0.1f; // клэф. распространение волны по поверхности
    int offs = 0;  // смещение
    public P[][] p;
